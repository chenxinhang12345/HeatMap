...
//Test the function of detect intersection
...
func TestAddObj(t *testing.T) {
	...
	nb.AddObject(Object{3.1, -3.1, "Android", 50}, true)
	...
	nb.AddObject(Object{2.51, -3.51, "iPhone", 50}, true)
	...
	nb.AddObject(Object{5, -5, "iPhone", 50}, true)
	...
	nb.AddObject(Object{5, -3, "Android", 50}, true)
	fmt.Println(nb.Root.CatRoot.Summary)
